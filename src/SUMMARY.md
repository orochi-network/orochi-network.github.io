...
- [Orochi Network](./orochi-network/orochi-network.md)
  ...
  - [Orand & Orocle](./orochi-network/orand-orocle.md)
  ...
  - [RAMenPaSTA](./ramenpasta/chapter.md)
    - [Generic Relaxed R1CS](./ramenpasta/ramenpasta-construction/generic-relaxed-r1cs.md)
    - [Conditional Folding Scheme for Generic Relaxed R1CS](./ramenpasta/ramenpasta-construction/conditional-folding-scheme.md)
    - [pvRAM from Conditional Folding Scheme](./ramenpasta/ramenpasta-construction/pvRAM-from-conditional-folding-scheme.md)
...
- [Deprecated](./orochi-network/orocle-v1.md)
